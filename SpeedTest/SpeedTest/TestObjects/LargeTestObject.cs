...
namespace SpeedTest.TestObjects
{
    public class LargeTestObject
    {
        ...
        public List<TestEnum> REnumCollection { get; set; }
        ...
        public List<List<SmallTestObject>> CrazySmallTestObjects { get; set; }
        public ICollection<SmallTestObject> RTestObject2Collection { get; set; }
        public List<short> LazyShorts { get; set; }
        public List<List<Collection<bool>>> CrazyBools { get; set; }
